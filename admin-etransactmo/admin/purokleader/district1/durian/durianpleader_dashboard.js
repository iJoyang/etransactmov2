document.addEventListener("DOMContentLoaded", () => {
    const handleAction = (userId, action) => {
        const endpoint = action === "accept"
            ? "/SYSTEMMMMM/admin/purokleader/district1/durian/durianaccept_resident.php"
            : "/SYSTEMMMMM/admin/purokleader/district1/durian/duriandecline_resident.php";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    changeEmailPasswordForm.addEventListener("submit", function (event) {
        ...
        fetch("/SYSTEMMMMM/admin/purokleader/district1/durian/durianupdate-user-details.php", {
            method: "POST",
            headers: {
